...
**Product Manager | Ecommerce Data Science & AI | Certified Scrum Product Owner**

![Profile Views](https://img.shields.io/badge/Profile%20Views-18,295-1abc9c.svg)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?logo=linkedin)](https://www.linkedin.com/in/raghvendra0027/)
[![AI Product](https://img.shields.io/badge/AI%20Product-AI%20Councel-green)](https://aicouncel.blogspot.com/)
[![Portfolio](https://img.shields.io/badge/UT%20Austin-Portfolio-orange)](https://www.mygreatlearning.com/eportfolio/raghvendra-singh5)

---

## 🚀 About Me

I am a **Certified Scrum Product Owner and Product Manager** with **6+ years of experience** building and scaling **B2B & B2C digital products** across **ecommerce, procurement, CRM, and AI-powered platforms**.

I specialize in **end-to-end product ownership** — from **product discovery and PRDs** to **roadmap planning, backlog prioritization, Agile delivery, and release management**.  
I work at the intersection of **business, technology, data, and AI** to deliver measurable outcomes.

---

## 🧠 Product Focus Areas

- 🛒 Ecommerce & Procurement Platforms (B2B / D2C)
- 🤖 AI & GenAI Products (LLMs, RAG, Agentic AI)
- 📊 Data-driven Product Decisions & Analytics
- 🚀 MVPs, Roadmaps, Releases & Scale
...
- Backlog Ownership & Prioritization (MoSCoW, RICE)  
- Sprint Planning, Reviews & Retrospectives  
- Stakeholder Communication & Alignment  

### Ecommerce & Platforms
- B2B & D2C Ecommerce Product Ownership  
- Vendor onboarding, catalog, pricing & checkout  
- Payments, logistics, CRM & OMS integrations  

### AI & Data (PM Perspective)
- AI Product Strategy & Use-case Definition  
- LLMs, RAG pipelines, Agentic AI concepts  
- SQL, Python, Tableau, Power BI  
- Funnel analysis, KPIs, experimentation  

### Tools
Jira · Confluence · Figma · Git · GitHub · Google Cloud · VS Code

---

## 🏆 Featured Product Case Studies

### 🏫 EDI School Mart – B2B Procurement Platform
**Role:** Product Head / Product Owner  
- Led product discovery with schools & vendors  
- Owned PRD, roadmap, backlog & releases  
- Integrated ecommerce, CRM, logistics & payments  
- Improved fulfilment efficiency by **30%**  
- Increased B2B traffic & leads by **40%**

---

### 🤖 AI Councel – AI Career Guidance Platform
**Role:** Product Owner / AI Product Manager  
- Built AI-powered career guidance using psychometric assessments  
- Designed full journey: onboarding → AI report → payment  
- Used **Gemini LLM (2.5 Pro)** with cloud & API integrations  
- Owned MVP, roadmap, backlog & release planning  

---

### 👗 D2C Ecommerce Launch – Fashion Brand
**Role:** Ecommerce Product Manager  
- Owned launch roadmap from ideation to go-live  
- Managed sprints, UAT & releases  
- Integrated OMS, CRM, logistics & marketing tools  

---

## 📊 KPIs & Metrics I Work With

- Sprint Velocity & Burndown / Burnup  
- Conversion Rate, GMV, AOV, CAC, LTV  
- Funnel Drop-offs & Feature Adoption  
- Release Predictability & Delivery Timelines  

---

## 🎯 Currently Exploring

- Scaling **AI-first products**
- Building **procurement + CRM platforms for education**
- Advanced **AI Product Management & Automation**
...
- **Advanced AI for Real-world Applications – IIT Kharagpur**  
...
- 🤖 AI Product: https://aicouncel.blogspot.com/  
- 📊 Portfolio: https://www.mygreatlearning.com/eportfolio/raghvendra-singh5  
